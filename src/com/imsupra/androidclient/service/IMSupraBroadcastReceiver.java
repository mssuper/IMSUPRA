...
public class IMSupraBroadcastReceiver extends BroadcastReceiver {
	static final String TAG = "IMSupraBroadcastReceiver";
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intent.getAction().equals(Intent.ACTION_SHUTDOWN)) {
			...
			xmppServiceIntent.setAction("de.hdmstuttgart.imsupra.XMPPSERVICE");
