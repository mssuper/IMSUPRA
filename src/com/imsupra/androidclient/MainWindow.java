...
import com.imsupra.androidclient.IXMPPRosterCallback.Stub;
...
import com.imsupra.androidclient.dialogs.AddRosterItemDialog;
import com.imsupra.androidclient.dialogs.ChangeStatusDialog;
import com.imsupra.androidclient.dialogs.FirstStartDialog;
import com.imsupra.androidclient.dialogs.GroupNameView;
import com.imsupra.androidclient.preferences.MainPrefs;
import com.imsupra.androidclient.service.XMPPService;
import com.imsupra.androidclient.util.ConnectionState;
import com.imsupra.androidclient.util.PreferenceConstants;
import com.imsupra.androidclient.util.SimpleCursorTreeAdapter;
import com.imsupra.androidclient.util.StatusMode;
import com.nullwire.trace.ExceptionHandler;

public class MainWindow extends SherlockExpandableListActivity {

	private static final String TAG = "imsupra.MainWindow";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mConfig = IMSupraApplication.getConfig(this);
		...
		mConfig = new IMSupraConfiguration(PreferenceManager.getDefaultSharedPreferences(this));
	...
	protected void onPause() {
		...
		IMSupraApplication.getApp(this).mMTM.unbindDisplayActivity(this);
		unbindXMPPService();
		storeExpandedState();
	}
	...
	protected void onResume() {
		...
		IMSupraApplication.getApp(this).mMTM.bindDisplayActivity(this);
...
/*
	...
	private void startChatActivity(String user, String userName, String message) {
		Intent chatIntent = new Intent(this,
				com.imsupra.androidclient.chat.ChatWindow.class);
		Uri userNameUri = Uri.parse(user);
		chatIntent.setData(userNameUri);
		chatIntent.putExtra(com.imsupra.androidclient.chat.ChatWindow.INTENT_EXTRA_USERNAME, userName);
		if (message != null) {
			chatIntent.putExtra(com.imsupra.androidclient.chat.ChatWindow.INTENT_EXTRA_MESSAGE, message);
		}
	...
	private int getShowHideMenuIcon() {
		...
		String versionTitle = getString(R.string.app_name);
		try {
...
*/
	...
	private void registerXMPPService() {
		...
		xmppServiceIntent.setAction("com.imsupra.androidclient.XMPPSERVICE");
	...
	private void registerCrashReporter() {
		if (mConfig.reportCrash) {
			ExceptionHandler.register(this, "http://duenndns.de/imsupra-crash/");
		}
	}
