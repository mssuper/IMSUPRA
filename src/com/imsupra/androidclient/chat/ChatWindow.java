package com.imsupra.androidclient.chat;
...
public class ChatWindow extends SherlockListActivity implements OnKeyListener,
	...
	private static final String TAG = "imsupra.ChatWindow";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mChatFontSize = Integer.valueOf(IMSupraApplication.getConfig(this).chatFontSize);
	...
	private void registerXMPPService() {
		...
		mServiceIntent.setAction("com.imsupra.androidclient.XMPPSERVICE");
