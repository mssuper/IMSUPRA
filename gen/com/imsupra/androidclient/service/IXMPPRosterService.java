 ...
 * Original file: U:\\Fontes\\IMSupra206\\IMSupra\\src\\com\\imsupra\\androidclient\\service\\IXMPPRosterService.aidl
 */
package com.imsupra.androidclient.service;
public interface IXMPPRosterService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.imsupra.androidclient.service.IXMPPRosterService
{
private static final java.lang.String DESCRIPTOR = "com.imsupra.androidclient.service.IXMPPRosterService";
...
/**
 * Cast an IBinder object into an com.imsupra.androidclient.service.IXMPPRosterService interface,
 * generating a proxy if needed.
 */
public static com.imsupra.androidclient.service.IXMPPRosterService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.imsupra.androidclient.service.IXMPPRosterService))) {
return ((com.imsupra.androidclient.service.IXMPPRosterService)iin);
}
return new com.imsupra.androidclient.service.IXMPPRosterService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.imsupra.androidclient.IXMPPRosterCallback _arg0;
_arg0 = com.imsupra.androidclient.IXMPPRosterCallback.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements com.imsupra.androidclient.service.IXMPPRosterService
{
...
/* callback methods */
@Override public void registerRosterCallback(com.imsupra.androidclient.IXMPPRosterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void unregisterRosterCallback(com.imsupra.androidclient.IXMPPRosterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/* callback methods */
public void registerRosterCallback(com.imsupra.androidclient.IXMPPRosterCallback callback) throws android.os.RemoteException;
public void unregisterRosterCallback(com.imsupra.androidclient.IXMPPRosterCallback callback) throws android.os.RemoteException;
}
